                    ...
                    <div className="lg:w-80 bg-linear-to-br from-blue-50 to-indigo-50 border-l border-gray-200 p-8 flex flex-col items-center justify-center">
                        <div className="flex flex-col items-center w-full max-w-xs">
                            ...
                            <div className="space-y-3 w-full">
                                ...
                                <button className="w-full bg-white hover:bg-gray-50 text-gray-700 font-medium py-3 px-6 rounded-lg transition-all duration-200 border-2 border-gray-300 hover:border-blue-400 flex items-center justify-center gap-2">
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
