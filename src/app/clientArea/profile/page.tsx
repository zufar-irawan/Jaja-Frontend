...
export default function ProfilePage() {
  ...
  return (
    <div className="flex flex-col w-full gap-6">
            ...
            <div className="mb-8">
              ...
              <div className="space-y-5">
                <div className="flex items-start">
                  <span className="text-sm font-medium text-gray-500 w-36">
                    Nama
                  </span>
                ...
                <div className="flex items-start">
                  ...
                  <span className="text-sm text-gray-900">
                    {isLoading ? "Sabar tungguin..." : user?.tgl_lahir || "-"}
                  </span>
                </div>
            ...
            <div>
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start">
                  ...
                  <span className="text-sm text-gray-900">
                    {isLoading ? "Sabar tungguin..." : user?.telepon}
                  </span>
                </div>
              </div>
            </div>
      ...
      {modalEditProfile && <ProfileEditModal onClose={setModalEditProfile} />}
    </div>
  );
}
