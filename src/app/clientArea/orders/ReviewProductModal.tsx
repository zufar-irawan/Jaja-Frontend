        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                {previewDepan ? (
                  ...
                  <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-[#55B4E5] hover:bg-gray-50 transition-colors">
          ...
          <div className="flex gap-3 pt-4 border-t border-gray-200">
            ...
            <button
              ...
              className="flex-1 px-6 py-3 bg-linear-to-r from-[#55B4E5] to-[#55B4E5]/90 text-white font-semibold rounded-lg hover:from-[#55B4E5]/90 hover:to-[#55B4E5] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-md hover:shadow-lg"
            >
              {isSubmitting ? (
                <>
