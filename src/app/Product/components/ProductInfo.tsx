...
export default function ProductInfo({ 
  ...
  return (
    <div style={{ 
      ...
      height: '484px', // Height sama dengan ProductImages container
      display: 'flex',
      flexDirection: 'column'
    }}>
      {/* Bagian atas - scrollable jika perlu */}
        ...
        <div style={{ marginBottom: '16px' }}>
          <div style={{ 
            ...
            <div>
              ...
              <span style={{ fontSize: '14px', fontWeight: '600', color: '#1a1a1a' }}>Baru</span>
            </div>
            <div>
              <span style={{ fontSize: '14px', color: '#7f8c8d' }}>Berat : </span>
              <span style={{ fontSize: '14px', fontWeight: '600', color: '#1a1a1a' }}>2 kg</span>
            </div>
          </div>
          <div style={{ fontSize: '14px', color: '#7f8c8d' }}>
            Stok tersisa <span style={{ fontWeight: '600', color: '#e74c3c' }}>{currentVariant!.stock} buah</span>
          </div>
        </div>

        {/* Action Buttons & Quantity dalam satu baris */}
      ...
      {/* Bagian bawah - tetap di posisi bawah */}
      <div style={{ marginTop: 'auto' }}>
        ...
        <div style={{ 
          ...
          <span style={{ fontSize: '13px', color: '#7f8c8d' }}>
            <strong style={{ color: '#27ae60' }}>Garansi Resmi</strong> 2 Tahun dari Lenovo Indonesia
          </span>
        </div>
