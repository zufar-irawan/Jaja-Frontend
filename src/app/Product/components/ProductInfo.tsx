  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      const cartData = {
        ...
        model_variasi:
          selectedVariant !== "Standard" ? selectedVariant : undefined,
      ...
      const result = await Swal.fire({
        icon: "success",
        title:
          '<span style="color: #1a1a1a; font-family: Poppins, sans-serif;">Berhasil Ditambahkan!</span>',
        html: `
              ...
              {variants.map((variant) => (
                <button
                  ...
                  style={{
                    padding: "10px 16px",
                    backgroundColor:
                      selectedVariant === variant.name ? "#55B4E5" : "#f9fafb",
                    color:
                      selectedVariant === variant.name ? "white" : "#374151",
                    border:
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              ...
              <button
                onClick={() =>
                  handleQuantityChange(Math.min(productStock, quantity + 1))
                }
          ...
          <button
            ...
            style={{
              ...
              background:
                productStock === 0
                  ? "#cccccc"
                  : "linear-gradient(135deg, #FBB338 0%, #f59e0b 100%)",
              border: "none",
              color: "white",
              padding: "14px",
              borderRadius: "10px",
          ...
          <button
            ...
            style={{
              ...
              background:
                productStock === 0
                  ? "#cccccc"
                  : "linear-gradient(135deg, #55B4E5 0%, #3b9ed9 100%)",
              border: "none",
              color: "white",
              padding: "14px",
              borderRadius: "10px",
