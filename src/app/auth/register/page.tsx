      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#55B4E5] to-[#4A9FD0] items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-lg">
          ...
          <div className="flex justify-center mb-8">
            ...
            <div
              style={{ display: "none" }}
              className="w-32 h-32 bg-white rounded-full items-center justify-center shadow-2xl"
            >
        ...
        <div className="w-full max-w-md">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-[#55B4E5] text-white py-3 rounded-lg font-medium hover:bg-[#4A9FD0] transition shadow-md hover:shadow-lg mt-6"
            >
              Daftar
            </button>
