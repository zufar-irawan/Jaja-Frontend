          ...
          <div className="space-y-5">
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">
                Tidak menerima kode?{' '}
                {resendTimer > 0 ? (
                  <span className="text-gray-400">Kirim ulang dalam {resendTimer}s</span>
                ) : (
                  <button 
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#55B4E5] to-[#4A9FD0] items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-lg">
          <div className="flex justify-center mb-8">
            ...
            <div style={{display: 'none'}} className="w-32 h-32 bg-white rounded-full flex items-center justify-center shadow-2xl">
              <svg width="80" height="80" viewBox="0 0 100 100" fill="none">
                <rect x="25" y="35" width="50" height="40" rx="5" stroke="#55B4E5" strokeWidth="4" fill="none"/>
                <path d="M35 35 V25 Q35 15 50 15 Q65 15 65 25 V35" stroke="#55B4E5" strokeWidth="4" fill="none"/>
                <circle cx="50" cy="55" r="8" fill="#FBB338"/>
                <path d="M50 63 L50 68" stroke="#FBB338" strokeWidth="4" strokeLinecap="round"/>
              </svg>
            </div>
          </div>
          ...
          <p className="text-xl text-blue-100 mb-8">
            Kami telah mengirimkan kode verifikasi 6 digit ke email Anda. Silakan periksa inbox atau folder spam Anda.
          </p>
