            ...
            {password && (
              <div className="space-y-2">
                ...
                <div className="flex gap-1">
                  ...
                  <div className={`h-1 flex-1 rounded ${/[A-Z]/.test(password) && /[a-z]/.test(password) ? 'bg-green-500' : 'bg-gray-300'}`}></div>
                  <div className={`h-1 flex-1 rounded ${/\d/.test(password) ? 'bg-green-500' : 'bg-gray-300'}`}></div>
                  <div className={`h-1 flex-1 rounded ${/[^A-Za-z0-9]/.test(password) ? 'bg-green-500' : 'bg-gray-300'}`}></div>
                </div>
              </div>
            )}
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#55B4E5] to-[#4A9FD0] items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-lg">
          <div className="flex justify-center mb-8">
            ...
            <div style={{display: 'none'}} className="w-32 h-32 bg-white rounded-full flex items-center justify-center shadow-2xl">
              <svg width="80" height="80" viewBox="0 0 100 100" fill="none">
                <circle cx="50" cy="50" r="30" stroke="#FBB338" strokeWidth="4" fill="none"/>
                <path d="M35 50 L45 60 L65 40" stroke="#55B4E5" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
          </div>
          ...
          <p className="text-xl text-blue-100 mb-8">
            Buat password baru yang kuat untuk akun Anda. Pastikan password mudah diingat namun sulit ditebak.
          </p>
